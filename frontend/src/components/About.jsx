...
const About = () => {
    ...
    return ( 
        <div className="animate-fadeIn  w-full h-screen 2xl:flex pt-[20%] lg:pt-[10%]  md:block    ">
            ...
            <div className="border  2xl:border-none border-gray-700 text-gray-400 text-[18px] lg:pt-[10%] p-4 mx-2 rounded-md 2xl:w-[70%]  pb-20 text-left mb-4 scroll-container scroll-hidde">
